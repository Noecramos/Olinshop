...
export default function CheckoutPage() {
    ...
    return (
        <div className="min-h-screen bg-[#F5F5F7] flex flex-col">
            {/* Header Banner */}
            <div className="h-48 md:h-64 w-full bg-contain bg-center bg-no-repeat bg-[#DCD9EE] relative rounded-b-3xl shadow-md overflow-hidden" style={{ backgroundImage: "url('/header-lojaky.png')" }}>
