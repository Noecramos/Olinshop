        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-[#F5F5F7] to-[#E8E8EA] flex flex-col items-center justify-center py-8 px-4">
                <div className="w-full max-w-lg">
                    ...
                    <div className="h-40 md:h-56 w-full bg-cover bg-top relative rounded-t-3xl overflow-hidden shadow-lg" style={{ backgroundImage: "url('/header-lojaky.png')" }}>
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#F5F5F7] to-[#E8E8EA] flex flex-col items-center py-10 px-4">
            <div className="w-full max-w-7xl">
                {/* Header Banner - Same width as card */}
                <div className="h-40 md:h-56 w-full bg-cover bg-top relative rounded-t-3xl overflow-hidden shadow-xl" style={{ backgroundImage: "url('/header-lojaky.png')" }}>
