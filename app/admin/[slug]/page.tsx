        ...
        win.document.write(`
            <html>
                ...
                <body>
                    ...
                    ${order.observations ? `<hr class="sep"><p style="font-size: 10px;"><strong>OBS:</strong> ${order.observations}</p>` : ''}
                    <hr class="sep">
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#F5F5F7] to-[#E8E8EA] flex">
            ...
            <main className="flex-1 overflow-y-auto pb-24 lg:pb-0">
                {/* Header Banner */}
                <div className="h-32 md:h-40 w-full bg-cover bg-center relative overflow-hidden shadow-lg rounded-b-3xl" style={{ backgroundImage: "url('/header-lojaky.png')" }}>
